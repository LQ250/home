...
import { useDynamicList } from '~/hook/useHooks'

import type { RightClickData, shortcutData } from '~/hook/zustand'
    ...
    return (
        <AlertDialog open={open}>
            <AlertDialogTrigger asChild>
                ...
                >
                    <main className="w-[4rem] h-[4rem] bg-background/60 hover:bg-background/80 rounded-lg flex items-center justify-center">
                        <BiBookAdd size={32} />
                    </main>
