...
/* =========| hook |========= */
import { useWindowSize } from '~/hook/getWindowSize'
import { calcGridMaxBox } from '~/hook/getTemplateQuantity'
import { openPage } from '~/hook/globalData'
import type { shortcutData } from '~/hook/zustand'
import { useUserStore } from '~/hook/zustand'
import { useGlobalData, useShallow } from '~/hook/globalData'
    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="rounded-lg mr-2 cursor-pointer bg-white flex items-center justify-center"
            >
                <GoMoveToTop
