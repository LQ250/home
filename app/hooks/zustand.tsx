...
const defaultDock: shortcutData[] = [
	...
	{
		id: '318b4483-550f-4fdc-9789-63967d4a1d3b',
	...
	{
		id: '00b87451-a464-4ff5-baa2-6a033558a0bd',
...
type ConfigStore = {
	bgType: 'external' | 'local'
	setBgType: (bgType: ConfigStore['bgType']) => void
...
export const defaultBgUrl = '/bg.png'

export const getBgUrl = async (type: 'external' | 'local') => {
	if (type === 'external') {
		const url = localStorage.getItem('bgUrl')
		return url || defaultBgUrl
	}

	const url = await get('BgUrlBase64')
	return url || defaultBgUrl
}
